...
export type OrderDisplayFragment = { delivery: number, methodPayment: string, total: number, orderItems: Array<{ id: string, width: number, height: number, product?: { images: Array<{ url: string }> } | null }> };
...
export type GetOrderQuery = { order?: { delivery: number, methodPayment: string, total: number, orderItems: Array<{ id: string, width: number, height: number, product?: { images: Array<{ url: string }> } | null }> } | null };

...
export type AccountDiscountCodeUpdateManyInlineInput = {
  ...
  update?: InputMaybe<Array<AccountDiscountCodeUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple AccountDiscountCode documents */
  upsert?: InputMaybe<Array<AccountDiscountCodeUpsertWithNestedWhereUniqueInput>>;
};
...
export type DiscountCode = Entity & Node & {
...
export type NewsletterUser = Entity & Node & {
  /** The time the document was created */
  createdAt: Scalars['DateTime']['output'];
  /** User that created this document */
  createdBy?: Maybe<User>;
...
export type NewsletterUserDiscountCodesUpdateManyInlineInput = {
  ...
  update?: InputMaybe<Array<NewsletterUserDiscountCodesUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple NewsletterUserDiscountCodes documents */
  upsert?: InputMaybe<Array<NewsletterUserDiscountCodesUpsertWithNestedWhereUniqueInput>>;
};
...
export type OrderManyWhereInput = {
  ...
  /** All values that are not contained in given list. */
  paymentMethod_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** All values not starting with the given string. */
...
/** Type layout vertical or horizontal */
export type ProductVariantType = Entity & Node & {
...
export type ScheduledOperationAffectedDocument = Account | Asset | Category | Currency | DiscountCode | NewsletterUser | Order | OrderItem | Product | ProductVariantType | Review;
...
export type CreateAccountMutation = { createAccount?: { email: string, id: string } | null };
...
export type GetCategoriesQuery = { categories: Array<{ id: string, name: string, slug: string }> };
...
export type OrderDisplayFragment = { delivery: number, paymentMethod?: string | null, total: number, orderItems: Array<{ id: string, width: number, height: number, product?: { images: Array<{ url: string }> } | null }> };

export type ProductDisplayFragment = { sale?: string | null, id: string, name: string, slug: string, orientation: Orientation, whiteFrame: boolean, variants: Array<{ id: string, price: number, width: number, height: number }>, categories: Array<{ slug: string }>, images: Array<{ id: string, alt?: string | null, url: string }> };

export type ProductDetailsFragment = { id: string, name: string, description: string, paperWeight: number, orientation: Orientation, slug: string, color: string, sale?: string | null, whiteFrame: boolean, finish: string, variants: Array<{ id: string, width: number, height: number, price: number }>, categories: Array<{ id: string, name: string }>, images: Array<{ id: string, alt?: string | null, url: string }> };

export type ReviewProductFragment = { name: string, id: string, email: string, rating: number, content: string };

export type VariantFragment = { id: string, width: number, height: number, price: number };
...
export type UpdateOrderPaymentPaidMutation = { updateOrder?: { id: string } | null };
...
export type GetOrderQuery = { order?: { delivery: number, paymentMethod?: string | null, total: number, orderItems: Array<{ id: string, width: number, height: number, product?: { images: Array<{ url: string }> } | null }> } | null };

export type GetProductsToCarrouselQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProductsToCarrouselQuery = { products: Array<{ sale?: string | null, id: string, name: string, slug: string, orientation: Orientation, whiteFrame: boolean, variants: Array<{ id: string, price: number, width: number, height: number }>, categories: Array<{ slug: string }>, images: Array<{ id: string, alt?: string | null, url: string }> }> };

export type GetProductsToCarrouselByCategorySlugWithoutProductQueryVariables = Exact<{
  categorySlug: Scalars['String']['input'];
  productId: Scalars['ID']['input'];
}>;


export type GetProductsToCarrouselByCategorySlugWithoutProductQuery = { products: Array<{ sale?: string | null, id: string, name: string, slug: string, orientation: Orientation, whiteFrame: boolean, variants: Array<{ id: string, price: number, width: number, height: number }>, categories: Array<{ slug: string }>, images: Array<{ id: string, alt?: string | null, url: string }> }> };
...
export type GetProductsToCarrouselByCategorySlugQuery = { products: Array<{ sale?: string | null, id: string, name: string, slug: string, orientation: Orientation, whiteFrame: boolean, variants: Array<{ id: string, price: number, width: number, height: number }>, categories: Array<{ slug: string }>, images: Array<{ id: string, alt?: string | null, url: string }> }> };
...
export type GetProductBySlugQuery = { product?: { id: string, name: string, description: string, paperWeight: number, orientation: Orientation, slug: string, color: string, sale?: string | null, whiteFrame: boolean, finish: string, variants: Array<{ id: string, width: number, height: number, price: number }>, categories: Array<{ id: string, name: string }>, images: Array<{ id: string, alt?: string | null, url: string }> } | null };
...
export type GetDiscountCodesQuery = { discountCodes: Array<{ code: string, discount: number, used: boolean }> };
...
export type GetProductsByIdsQuery = { products: Array<{ id: string, variants: Array<{ id: string, price: number, width: number, height: number }> }> };
...
export type GetProductsByCategorySlugQuery = { products: Array<{ sale?: string | null, id: string, name: string, slug: string, orientation: Orientation, whiteFrame: boolean, variants: Array<{ id: string, price: number, width: number, height: number }>, categories: Array<{ slug: string }>, images: Array<{ id: string, alt?: string | null, url: string }> }>, categories: Array<{ name: string }>, productsConnection: { pageInfo: { pageSize?: number | null } } };
...
export type CreateReviewProductMutation = { createReview?: { id: string, stage: Stage } | null };
...
export type GetProductReviewsBySlugQuery = { product?: { reviews: Array<{ id: string, email: string, rating: number, content: string, name: string }> } | null };
...
export const CategoriesFragmentDoc = new TypedDocumentString(`
  ...
  slug
    ...
    `, {"fragmentName":"Categories"}) as unknown as TypedDocumentString<CategoriesFragment, unknown>;
export const OrderDisplayFragmentDoc = new TypedDocumentString(`
  ...
  total
    ...
    `, {"fragmentName":"OrderDisplay"}) as unknown as TypedDocumentString<OrderDisplayFragment, unknown>;
export const ImagesFragmentDoc = new TypedDocumentString(`
  ...
  url
    ...
    `, {"fragmentName":"Images"}) as unknown as TypedDocumentString<ImagesFragment, unknown>;
export const ProductDisplayFragmentDoc = new TypedDocumentString(`
  ...
  alt
  url
}`, {"fragmentName":"ProductDisplay"}) as unknown as TypedDocumentString<ProductDisplayFragment, unknown>;
...
export const UpdateOrderPaymentPaidDocument = new TypedDocumentString(`
  ...
  updateOrder(
    ...
    `) as unknown as TypedDocumentString<UpdateOrderPaymentPaidMutation, UpdateOrderPaymentPaidMutationVariables>;
...
}`) as unknown as TypedDocumentString<GetProductsToCarrouselQuery, GetProductsToCarrouselQueryVariables>;
export const GetProductsToCarrouselByCategorySlugWithoutProductDocument = new TypedDocumentString(`
...
}`) as unknown as TypedDocumentString<GetProductsToCarrouselByCategorySlugWithoutProductQuery, GetProductsToCarrouselByCategorySlugWithoutProductQueryVariables>;
export const GetProductsToCarrouselByCategorySlugDocument = new TypedDocumentString(`
...
}`) as unknown as TypedDocumentString<GetProductsToCarrouselByCategorySlugQuery, GetProductsToCarrouselByCategorySlugQueryVariables>;
export const GetProductsSlugsDocument = new TypedDocumentString(`
  ...
  products {
    ...
    `) as unknown as TypedDocumentString<GetProductsSlugsQuery, GetProductsSlugsQueryVariables>;
...
export const GetDiscountCodesDocument = new TypedDocumentString(`
  ...
  discountCodes(
    ...
    `) as unknown as TypedDocumentString<GetDiscountCodesQuery, GetDiscountCodesQueryVariables>;
export const GetProductsByIdsDocument = new TypedDocumentString(`
  ...
  products(where: {id_in: $productsId}) {
    ...
    `) as unknown as TypedDocumentString<GetProductsByIdsQuery, GetProductsByIdsQueryVariables>;
...
export const CreateReviewProductDocument = new TypedDocumentString(`
  ...
  createReview(data: $review) {
    ...
    `) as unknown as TypedDocumentString<CreateReviewProductMutation, CreateReviewProductMutationVariables>;
export const GetProductReviewsBySlugDocument = new TypedDocumentString(`
  ...
  product(where: {slug: $slug}, stage: DRAFT) {
    ...
    `) as unknown as TypedDocumentString<GetProductReviewsBySlugQuery, GetProductReviewsBySlugQueryVariables>;
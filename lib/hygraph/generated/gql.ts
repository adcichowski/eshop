 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment Categories on Category {\n  id\n  name\n  slug\n}"): typeof import('./graphql').CategoriesFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment Images on Asset {\n  id\n  alt\n  url\n}"): typeof import('./graphql').ImagesFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment OrderDisplay on Order {\n  orderItems {\n    id\n    width\n    height\n    product {\n      images(first: 1) {\n        url\n      }\n    }\n  }\n  delivery\n  methodPayment\n  total\n}"): typeof import('./graphql').OrderDisplayFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment ProductDisplay on Product {\n  sale\n  id\n  name\n  slug\n  orientation\n  whiteFrame\n  variants(orderBy: price_ASC, first: 1) {\n    id\n    price\n    width\n    height\n  }\n  categories {\n    slug\n  }\n  images {\n    ...Images\n  }\n}"): typeof import('./graphql').ProductDisplayFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment Variant on ProductVariantType {\n  id\n  width\n  height\n  price\n}"): typeof import('./graphql').VariantFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CreateOrder($email: String!, $totalOrderPrice: Int!, $stripeCheckoutId: String!, $orderItems: OrderItemCreateManyInlineInput!, $statusOrder: StatusOrder!, $methodPayment: String!, $delivery: Int!) {\n  createOrder(\n    data: {email: $email, total: $totalOrderPrice, stripeCheckoutId: $stripeCheckoutId, orderItems: $orderItems, statusOrder: $statusOrder, methodPayment: $methodPayment, delivery: $delivery}\n  ) {\n    id\n  }\n}\n\nmutation UpdateOrderPaymentPaid($stripeCheckoutId: String!) {\n  updateOrder(\n    data: {statusOrder: PAID}\n    where: {stripeCheckoutId: $stripeCheckoutId}\n  ) {\n    id\n  }\n}"): typeof import('./graphql').CreateOrderDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetOrder($orderId: ID!) {\n  order(where: {id: $orderId}, stage: DRAFT) {\n    ...OrderDisplay\n  }\n}"): typeof import('./graphql').GetOrderDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetProductsToCarrousel {\n  products(first: 12) {\n    ...ProductDisplay\n  }\n}\n\nquery GetProductsToCarrouselByCategorySlugWithoutProduct($categorySlug: String!, $productId: ID!) {\n  products(\n    first: 12\n    where: {categories_some: {slug: $categorySlug}, id_not: $productId}\n  ) {\n    ...ProductDisplay\n  }\n}\n\nquery GetProductsToCarrouselByCategorySlug($categorySlug: String!) {\n  products(first: 12, where: {categories_some: {slug: $categorySlug}}) {\n    ...ProductDisplay\n  }\n}\n\nquery GetProductsSlugs {\n  products {\n    slug\n  }\n}\n\nquery GetProductBySlug($slug: String) {\n  product(where: {slug: $slug}) {\n    ...ProductDetails\n  }\n}\n\nquery GetDiscountCodes($code: String!, $email: String!) {\n  discountCodes(\n    where: {code_contains: $code, used: false, accounts_some: {email: $email}}\n    stage: DRAFT\n  ) {\n    code\n    discount\n    used\n  }\n}\n\nquery GetProductsByIds($productsId: [ID!]!) {\n  products(where: {id_in: $productsId}) {\n    id\n    variants {\n      id\n      price\n      width\n      height\n    }\n  }\n}\n\nquery GetProductsByCategorySlug($categorySlug: String!, $skip: Int!, $first: Int!) {\n  products(\n    first: $first\n    where: {categories_some: {slug: $categorySlug}}\n    skip: $skip\n  ) {\n    ...ProductDisplay\n  }\n  categories(where: {slug: $categorySlug}) {\n    name\n  }\n  productsConnection(skip: $skip, where: {categories_some: {slug: $categorySlug}}) {\n    pageInfo {\n      pageSize\n    }\n  }\n}"): typeof import('./graphql').GetProductsToCarrouselDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CreateReviewProduct($review: ReviewCreateInput!) {\n  createReview(data: $review) {\n    id\n    stage\n  }\n}"): typeof import('./graphql').CreateReviewProductDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetProductReviewsBySlug($slug: String!) {\n  product(where: {slug: $slug}, stage: DRAFT) {\n    reviews {\n      id\n      email\n      rating\n      content\n      name\n    }\n  }\n}"): typeof import('./graphql').GetProductReviewsBySlugDocument;
